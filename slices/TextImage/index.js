...
export const MySlice = ({ slice, position, background }) => {
  ...
  return (
    <section style={{ backgroundColor: bgColor }} className="py-10">
      <div className="container mx-auto text-center my-20 md:my-28 px-5">
